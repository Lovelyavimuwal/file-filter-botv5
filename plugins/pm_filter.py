...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton(text="⚠️ 𝐉𝐨𝐢𝐧 𝐌𝐨𝐯𝐢𝐞𝐬 Group ⚠️", url="https://t.me/+adCA3W3eR65mZjE1")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHANNEL 💠', url='https://t.me/+sb5yPaZ2SyI5Yjc9'),
            InlineKeyboardButton('☎️ CONTACT ME', url='https://t.me/lovekyavimuwal'),
            InlineKeyboardButton('💠 UPDATES 💠', url='https://t.me/goodnightmovies')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('🌴 Bots Channel 🌴', url='https://t.me/goodnightmovies'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton(text="⚠️ 𝐉𝐨𝐢𝐧 𝐌𝐨𝐯𝐢𝐞𝐬 𝙂𝙧𝙤𝙪𝙥 ⚠️", url="https://t.me/+adCA3W3eR65mZjE1")
    ])
