...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            ...
            [
                InlineKeyboardButton('♻️ Updates Channel ♻️', url='https://t.me/goodnightmovies')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('☎️CONTACT ME', url='https://t.me/lovelyavimuwal'),
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHANNEL 💠', url='https://t.me/+sb5yPaZ2SyI5Yjc9'),
            InlineKeyboardButton('☎️ CONTACT ME', url='https://t.me/lovelyavimuwal'),
            InlineKeyboardButton('💠 UPDATES 💠', url='https://t.me/goodnightmovies')
            ],[
    ...
    await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('♻️ 𝐉𝐨𝐢𝐧 𝙂𝙧𝙤𝙪𝙥 ', url="https://t.me/+adCA3W3eR65mZjE1")
                ]
            ]
        )
    )                
